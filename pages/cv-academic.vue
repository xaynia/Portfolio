...
<!--          </li>-->
        ...
        <ul>
          ...
          <li>
            ...
            Experimental game design and rapid prototyfor ping. Built <em>Horse Jumper Simulator</em> in Unreal Engine 5.6 using Blueprints, focusing on moment‑to‑moment feel, timing, and readable goals.
          </li>
          <li>
          ...
          <li>
            ...
            Max MSP, Jitter, and RNBO. Built synthesizers, drum machines, and an
      ...
      <!-- Projects -->
      <h2>Academic & Creative Projects</h2>
